<form action="/" method="get">
    <input type="text" name="s" id="search" placeholder="Type something to search…" value="<?php the_search_query(); ?>" />
    <button type="submit" title="Search"><svg width="16" height="17" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
